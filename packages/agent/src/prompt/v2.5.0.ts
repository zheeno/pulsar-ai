...
${isCrypto ? `- news.headlines are titles from CoinDesk, Decrypt, and The Block RSS. Delayed, incomplete, already in the tape. Do not BUY because a headline is bullish. Do not invent headlines. If news.status is unavailable/empty/absent, proceed without news
